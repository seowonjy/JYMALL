                    ...
                    <div class="admin_content_main">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<input name="itemName" value="<c:out value="${goodsInfo.itemName}"/>" disabled>
                    			</div>
                    		</div>
                    		<div class="form_section">
                    			<div class="form_section_title">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<input name="cryear" autocomplete="off" readonly="readonly" value="<c:out value="${goodsInfo.cryear}"/>" disabled>                   				
                    			</div>
                    		</div>            
                    		<div class="form_section">
                    			<div class="form_section_title">
                    			...
                    			<div class="form_section_content">
                    				<input name="creater" value="<c:out value="${goodsInfo.creater}"/>" disabled>
                    			</div>
                    		</div>             
                    		<div class="form_section">
                    			<div class="form_section_title">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<input name="itemPrice" value="<c:out value="${goodsInfo.itemPrice}"/>" disabled>
                    			</div>
                    		</div>               
                    		<div class="form_section">
                    			<div class="form_section_title">
                    			...
                    			<div class="form_section_content">
                    				<input name="itemStock" value="<c:out value="${goodsInfo.itemStock}"/>" disabled>
                    			</div>
                    		</div>          
                    		<div class="form_section">
                    			<div class="form_section_title">
